                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('Product.destroy', $product->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="input-2" name="price" value="{{ $product->price }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="input-3">Descripción</label>
                                    <textarea name="description" class="form-control" id="" cols="30" rows="10" disabled>{{ $product->description }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group py-2">
                                    <div class="icheck-material-white">
                                        <input type="checkbox" id="user-checkbox1" name="status" disabled {{ $product->status == '1' ? 'checked':'' }} />
