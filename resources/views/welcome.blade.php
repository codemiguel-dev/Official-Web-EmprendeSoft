...
<body>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__item set-bg" data-setbg="img/back_1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <span>Prueba software gratis</span>
                                <h2>Base de dato local</h2>
                                <a href="#" class="primary-btn">Descargar gratis</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hero__item set-bg" data-setbg="img/back_2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <span>Prueba software gratis</span>
                                <h2>Base de datos remota</h2>
                                <a href="#" class="primary-btn">Prueba gratis web</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="services__title">
                        <div class="section-title">
                            <span>Serivicios de software</span>
                            <h2>?</h2>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="services__item">
                                ...
                                <h4>Distintas funcionalidades</h4>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="services__item">
                                ...
                                <h4>Material de uso en línea</h4>
                                <p>Whether you’re halfway through the editing process, or you haven’t even started, our
                                    post production services can put the finishing touches.</p>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="callto__text">
                        ...
                        <a href="{{ route('Category.client.index') }}">Tienda en línea</a>
                    </div>
                </div>
            </div>
        </div>
